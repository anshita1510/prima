 ...
 */
router.get('/users/all', (0, role_middleware_1.authorizeRoles)(['SUPER_ADMIN', 'ADMIN']), employee_controller_1.employeeController.getAllUsers);
 ...
 */
router.get('/team/members', (0, role_middleware_1.authorizeRoles)(['MANAGER']), employee_controller_1.employeeController.getManagerTeamMembers);
 ...
 *         description: Forbidden - Manager only
 */
router.get('/team/unassigned', (0, role_middleware_1.authorizeRoles)(['MANAGER']), employee_controller_1.employeeController.getUnassignedEmployees);
 ...
 */
router.get('/:employeeId/stats', employee_controller_1.employeeController.getEmployeeStats);
 ...
 *         description: Forbidden - Admin/Super Admin only
 */
router.post('/', (0, role_middleware_1.authorizeRoles)(['SUPER_ADMIN', 'ADMIN', 'MANAGER']), employee_controller_1.employeeController.createEmployee);
 ...
 */
router.get('/', (0, role_middleware_1.authorizeRoles)(['SUPER_ADMIN', 'ADMIN', 'MANAGER']), employee_controller_1.employeeController.getAllEmployees);
 ...
 *         description: Employee not found
 */
router.post('/team/assign/:employeeId', (0, role_middleware_1.authorizeRoles)(['MANAGER']), employee_controller_1.employeeController.assignEmployeeToManager);
// Get employee by ID
/**
 * @swagger
 ...
 *         description: Employee not found
 */
router.get('/:employeeId', employee_controller_1.employeeController.getEmployeeById);
 ...
 *         description: Employee not found
 */
router.put('/:employeeId', (0, role_middleware_1.authorizeRoles)(['SUPER_ADMIN', 'ADMIN']), employee_controller_1.employeeController.updateEmployee);
 ...
 *         description: Employee not found
 */
router.delete('/:employeeId', (0, role_middleware_1.authorizeRoles)(['SUPER_ADMIN', 'ADMIN']), employee_controller_1.employeeController.deleteEmployee);
