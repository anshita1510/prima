...
class LeaveApprovalService {
     ...
     */
    async canApproveLeave(approverId, approverRole, leaveId) {
        ...
        if (applicantDesignation === client_1.Designation.INTERN ||
            applicantDesignation === client_1.Designation.SOFTWARE_ENGINEER ||
            applicantDesignation === client_1.Designation.SENIOR_ENGINEER ||
            applicantDesignation === client_1.Designation.TECH_LEAD) {
            // Junior employees can be approved by MANAGER or HR
            if (approverDesignation === client_1.Designation.MANAGER || approverDesignation === client_1.Designation.HR) {
        ...
        if (applicantDesignation === client_1.Designation.MANAGER) {
            // Managers can be approved by HR, MANAGER, or DIRECTOR
            if (approverDesignation === client_1.Designation.HR ||
                approverDesignation === client_1.Designation.MANAGER ||
                approverDesignation === client_1.Designation.DIRECTOR) {
                return { canApprove: true };
            }
            return {
                canApprove: false,
        ...
        if (applicantDesignation === client_1.Designation.HR) {
            // HR can be approved by MANAGER, HR, DIRECTOR or CEO (SUPER_ADMIN role)
            if (approverDesignation === client_1.Designation.MANAGER ||
                approverDesignation === client_1.Designation.HR ||
                approverDesignation === client_1.Designation.DIRECTOR ||
        ...
        if (applicantDesignation === client_1.Designation.DIRECTOR) {
     ...
     */
    async getApprovableLeaves(approverId, approverRole, companyId) {
        // Get approver's designation
        const approver = await prisma.employee.findUnique({
            where: { id: approverId },
        ...
        if (approverDesignation === client_1.Designation.MANAGER) {
            ...
            whereClause.employee = {
                ...whereClause.employee,
                designation: {
                    in: [client_1.Designation.INTERN, client_1.Designation.SOFTWARE_ENGINEER, client_1.Designation.SENIOR_ENGINEER, client_1.Designation.TECH_LEAD, client_1.Designation.HR, client_1.Designation.MANAGER]
                }
            };
        }
        else if (approverDesignation === client_1.Designation.HR) {
            // HR can approve junior employees, Managers, and other HR
            whereClause.employee = {
                ...whereClause.employee,
                designation: {
                    in: [client_1.Designation.INTERN, client_1.Designation.SOFTWARE_ENGINEER, client_1.Designation.SENIOR_ENGINEER, client_1.Designation.TECH_LEAD, client_1.Designation.MANAGER, client_1.Designation.HR]
                }
            };
        }
        else if (approverDesignation === client_1.Designation.DIRECTOR) {
            // Directors can approve manager and HR designation leaves
            whereClause.employee = {
                ...whereClause.employee,
                designation: {
                    in: [client_1.Designation.MANAGER, client_1.Designation.HR]
                }
            };
        }
            ...
            whereClause.employee = {
                ...whereClause.employee,
                designation: {
                    in: [client_1.Designation.INTERN, client_1.Designation.SOFTWARE_ENGINEER, client_1.Designation.SENIOR_ENGINEER, client_1.Designation.TECH_LEAD, client_1.Designation.MANAGER, client_1.Designation.HR, client_1.Designation.DIRECTOR]
                }
            };
        }
        else {
     ...
     */
    async getLeaveStatistics(employeeId, companyId) {
        ...
        const stats = {
            total: leaves.length,
            pending: leaves.filter(l => l.status === client_1.LeaveStatus.PENDING).length,
            approved: leaves.filter(l => l.status === client_1.LeaveStatus.APPROVED).length,
            rejected: leaves.filter(l => l.status === client_1.LeaveStatus.REJECTED).length,
            cancelled: leaves.filter(l => l.status === client_1.LeaveStatus.CANCELLED).length,
            byType: {
     ...
     */
    async checkOverlappingLeaves(employeeId, startDate, endDate, excludeLeaveId) {
        const whereClause = {
            employeeId,
            status: {
