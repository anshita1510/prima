...
const USER_NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "projects", name: "Projects", icon: FolderOpen, href: "/user/projects" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "leave", name: "Leave", icon: CalendarDays, href: "/user/leave-management" },
    ],
  },
];
...
export default function UserPrimaSidebar() {
    ...
    <>
      ...
      >
        ...
        <nav className="min-h-0 flex-1 space-y-0 overflow-y-auto overflow-x-hidden px-2 py-3">
          {USER_NAV_SECTIONS.map((section, si) => (
